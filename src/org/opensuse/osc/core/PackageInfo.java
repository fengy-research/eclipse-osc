...
public class PackageInfo extends XMLFile {
	/**
	 * NOTE: This constructor takes a IProject handle, not the underlying IFile
	 * handle for `package.xml'!.
	 * 
	 * @param project
	 */
	...
	public org.opensuse.osc.api.Package getApiPackage()
			throws org.opensuse.osc.api.OSCException {
	...
	public String getTemplate() {
		...
		"<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<osc>"
				+ "<host url=\"\" username=\"\" password=\"\"/>"
				+ "<package project=\"\" package=\"\"/>" + "</osc>";
	}
